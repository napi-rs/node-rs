// napi-rs-artifact-metadata:{"version":2,"rootEntry":"index.js","exports":["Algorithm","hash","hashRaw","hashRawSync","hashSync","parseOptions","verify","verifySync","Version"],"managedRootEntries":["browser.js","index.js","argon2.wasm","argon2.debug.wasm"]}
/* eslint-disable */
/* prettier-ignore */
...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  const __wasiPackageEntry = require.resolve('@node-rs/argon2-wasm32-wasi')
  ...
  if (!__nodeFs.existsSync(__packagedWasmFilePath)) {
    throw new Error(
      '@node-rs/argon2-wasm32-wasi is installed but is missing argon2.wasm32-wasi.wasm.',
    )
  }
...
module.exports.parseOptions = __napiModule.exports.parseOptions
