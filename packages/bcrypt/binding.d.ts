...
export declare function genSalt(round: number, version?: string | undefined | null, signal?: AbortSignal | undefined | null): Promise<string>

export declare function genSaltSync(round: number, version?: string | undefined | null): string

export declare function hash(input: string | Uint8Array, cost: number | undefined | null, salt: string | Uint8Array | undefined | null, version: string | undefined | null, rejectLongPasswords: boolean, signal?: AbortSignal | undefined | null): Promise<string>
