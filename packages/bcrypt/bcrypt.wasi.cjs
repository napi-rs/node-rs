// napi-rs-artifact-metadata:{"version":2,"rootEntry":"binding.js","exports":["BCRYPT_API_VERSION","DEFAULT_COST","genSalt","genSaltSync","hash","hashSync","verify","verifySync"],"managedRootEntries":["browser.js","binding.js","bcrypt.wasm","bcrypt.debug.wasm"]}
/* eslint-disable */
/* prettier-ignore */
...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  const __wasiPackageEntry = require.resolve('@node-rs/bcrypt-wasm32-wasi')
  ...
  if (!__nodeFs.existsSync(__packagedWasmFilePath)) {
    throw new Error(
      '@node-rs/bcrypt-wasm32-wasi is installed but is missing bcrypt.wasm32-wasi.wasm.',
    )
  }
...
module.exports.BCRYPT_API_VERSION = __napiModule.exports.BCRYPT_API_VERSION
